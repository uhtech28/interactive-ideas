...
import { Sparkles, UserPlus, Lightbulb, Calendar, ArrowRight } from "lucide-react";
                ...
                >
                  ...
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <div className="flex flex-col items-end gap-2 shrink-0">
                      <div className="flex items-center gap-1 text-xs font-medium text-muted-foreground bg-muted/50 px-2 py-1 rounded-full" title="Sparks">
                        <Sparkles className="w-3 h-3 text-orange-500" />
                        {idea.sparkCount || 0}
                      </div>
                      <div className="flex items-center gap-1 text-xs font-medium text-muted-foreground bg-muted/50 px-2 py-1 rounded-full" title="Contributors">
