  ...
  return (
    <div className={cn('relative', className)}>
      ...
      {(showSearchResults || (showSuggestions && popularSuggestions.length > 0)) && (
        <div
          ref={suggestionsRef}
          className="fixed top-[64px] left-2 right-2 lg:absolute lg:top-full lg:left-0 lg:right-0 z-40 bg-background border lg:border-t-0 rounded-md lg:rounded-t-none lg:rounded-b-md shadow-xl lg:shadow-lg max-h-[70vh] lg:max-h-96 overflow-y-auto"
          role="listbox"
        >
