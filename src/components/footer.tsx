...
export default function FooterSection() {
  return (
    <footer className="py-16 md:py-32 relative z-20">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="my-8 flex flex-wrap justify-center gap-4 text-sm relative z-30">
          <a href={X_URL} target="_blank" rel="noopener noreferrer" aria-label="X/Twitter" className={ICON_CLASS}>
            <svg className="size-6 pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          ...
          <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={ICON_CLASS}>
            <svg className="size-6 pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          ...
          <a href={THREADS_URL} target="_blank" rel="noopener noreferrer" aria-label="Threads" className={ICON_CLASS}>
            <svg className="size-6 pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
          ...
          <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={ICON_CLASS}>
            <svg className="size-6 pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
